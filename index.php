...
<head>
    ...
    <script type="text/javascript" src="scripts/js/create_form.js" defer></script>
    <script type="text/javascript" src="scripts/js/send_form.js" defer></script>
...
<body>
    ...
    <header>
        <h1>Эта книга адресована всем, кто изучает русский язык.</h1>
    </header>

    <article>
        <h3>Эта книга адресована всем, кто изучает русский язык. Но состоит она не из правил, упражнений и учебных текстов. Для этого созданы другие замечательные учебники.
